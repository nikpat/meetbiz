...
//mongoose.connect('localhost', 'walki');
...
var businesses = mongoose.Schema({
		...
		account:{ _type:{type:String, default: "free"}},
		venues : [
				    { 
...
var business_account = mongoose.Schema({
	...
	verified_receipts		: [],	  //store last valid receipts
	original_receipt		: String,  //base64 encoded receipt to fetch latest recept
		...
		switch(schema)
		{
			case 'businesses':
 			...
 			case 'business_account':
 				return mongoose.model(schema, business_account);		
 		}
 	}
 	catch (err){
 		return err
